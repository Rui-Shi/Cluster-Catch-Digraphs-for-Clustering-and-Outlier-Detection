t1 = Sys.time()
source("/media/rui/exNVME/code_working_folder/SU-MCCDs/SU-MCCDs.R")
...
outlier.result = foreach(x=data.list,.packages = c("MASS","cluster")) %dopar% SUMCCD_outlier(x, simul=simul, min.cls=min.cls)
stopCluster(cl)
