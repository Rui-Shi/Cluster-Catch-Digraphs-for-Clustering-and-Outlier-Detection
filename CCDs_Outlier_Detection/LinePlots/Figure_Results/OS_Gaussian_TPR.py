...
file_path = 'G:/code_working_folder/Simulation_Results/Figure_Results/OS_Gaussian_TPR_TNR.xlsx'
...
# Ensure the order of algorithms is as specified: 'RKCCD-OOS', 'UNCCD-OOS', 'RKCCD-IOS', 'UNCCD-IOS'
algorithm_order = ['RKCCD-OOS', 'UNCCD-OOS', 'RKCCD-IOS', 'UNCCD-IOS']
