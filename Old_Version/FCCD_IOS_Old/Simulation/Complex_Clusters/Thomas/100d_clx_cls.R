...
source("/mmfs1/home/rzs0112/code_working_folder/Outlyingness_Score/FCCD_IOS.R")
...
source("/mmfs1/home/rzs0112/code_working_folder/FCCD_IOS/Simulation/Gaussian/Threshold.R")
...
IOS_scores = foreach(x=data.list,.packages = c("MASS","cluster","igraph")) %dopar% FCCD_IOS(datax=x,simul=simul,d=d,quant=quant)
stopCluster(cl)
...
save.image("/mmfs1/home/rzs0112/code_working_folder/FCCD_IOS/Simulation/Complex_Clusters/Thomas/100d_clx_cls.RData")
