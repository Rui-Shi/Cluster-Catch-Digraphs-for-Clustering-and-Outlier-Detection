...
noise_level = 0.01
sigma = 1/qnorm((1-noise_level)^(1/d))
...
save.image(here::here("simulations/outlier_detection/Algo_Compare_OutlierDetection/LOF/Simulation/Gaussian/100d/100d_2cls_n1000_cont5%.RData"))