...
outlier.result = foreach(x=data.list,.packages = c("MASS","cluster","igraph")) %dopar% MCCD.outlier(x)
stopCluster(cl)
t2 = Sys.time()
t2-t1
...
save.image(here::here("simulations/outlier_detection/RU-MCCDs/Simulation/Complex_Clusters/Matern/100d_clx_cls.RData"))