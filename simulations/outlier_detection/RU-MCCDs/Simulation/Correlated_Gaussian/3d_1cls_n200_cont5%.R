t1 = Sys.time()
source("/media/rui/exNVME/code_working_folder/RU-MCCDs/RU-MCCDs.R")
...
outlier.result = foreach(x=data.list,.packages = c("MASS","cluster")) %dopar% RUMCCD_outlier(x, simul=simul)
stopCluster(cl)
