...
print("10d_2cls_n500_cont51020%.R")
...
MFNNCCD.outlier = function(datax,simul){
  ...
  result.cls = nnccd.silhouette_mutual(Mgraph,datax,ind=NULL, lenClimit=Inf,k=10, min.cls = max(0.05,cont/2))
...
# try different density for the two clusters: 30% and 70%
n1 = round(n*(1-cont)*0.3)+1
n2 = round(n*(1-cont)*0.7)
n0 = round(n*cont)
