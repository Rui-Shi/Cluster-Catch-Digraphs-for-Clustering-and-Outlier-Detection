t1 = Sys.time()
source("/media/rui/exNVME/code_working_folder/UN-MCCDs/UN-MCCD.R")
...
outlier.result = foreach(x=data.list,.packages = c("MASS","cluster")) %dopar% UNMCCD_outlier(x, simul=simul)
stopCluster(cl)
