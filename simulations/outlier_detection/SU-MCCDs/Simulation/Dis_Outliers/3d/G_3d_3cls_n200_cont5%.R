...
# distances of outliers to cluster centers = 1.75
otl_dis = 1.5
...
# distances of outliers to cluster centers = 2
otl_dis = 1.75
...
# distances of outliers to cluster centers = 2.25
otl_dis = 2
...
# distances of outliers to cluster centers = 2.5
otl_dis = 2.25
