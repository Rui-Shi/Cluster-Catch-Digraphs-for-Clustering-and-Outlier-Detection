...
cls_dis = 1.5 # the distances between each cluster center
...
# distances between clusters = 2.5
otl_dis = 2.5
...
# distances between clusters = 3.5
otl_dis = 3.5
