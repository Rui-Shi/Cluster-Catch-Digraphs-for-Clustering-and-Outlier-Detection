...
iteN = 100 # the number of simulated data set.
...
save.image(here::here("simulations/outlyingness_scores/RKCCD_OOS_IOS/Simulation/Uniform/2d/2d_2cls_n1000_cont5%.RData"))