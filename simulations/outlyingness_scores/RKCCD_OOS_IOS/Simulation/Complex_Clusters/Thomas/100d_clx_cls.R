...
source(here::here("simulations/outlyingness_scores/RKCCD_OOS_IOS/Simulation/Complex_Clusters/Thomas/Threshold.R"))
...
save.image(here::here("simulations/outlyingness_scores/RKCCD_OOS_IOS/Simulation/Complex_Clusters/Thomas/100d_clx_cls.RData"))