...
source("/mmfs1/home/rzs0112/code_working_folder/UNCCD_OOS_IOS/Simulation/Gaussian/Threshold.R")
library(parallel)
library(doParallel)
library(MASS)
library(igraph)
...
save.image("/mmfs1/home/rzs0112/code_working_folder/UNCCD_OOS_IOS/Simulation/Gaussian/100d/100d_2cls_n1000_cont5%.RData")