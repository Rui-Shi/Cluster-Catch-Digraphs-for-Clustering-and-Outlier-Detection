...
source(here::here("simulations/outlyingness_scores/UNCCD_OOS_IOS/Simulation/Complex_Clusters/Matern/Threshold.R"))
...
IOS_scores = foreach(x=data.list,.packages = c("MASS","cluster","igraph")) %dopar% NNCCD_IOS(datax=x,simul=simul,method=method,d=d,min.cls=min.cls)
...
save.image(here::here("simulations/outlyingness_scores/UNCCD_OOS_IOS/Simulation/Complex_Clusters/Matern/100d_clx_cls.RData"))
